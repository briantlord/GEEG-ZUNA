...
2. Apply exactly one zero-phase **0.5–45 Hz FIR bandpass** before resampling. This selects ZUNA's documented band-limited training variant and removes the corpus-specific 124–128 Hz component that invalidated the first ZUNA 1.1 run.
