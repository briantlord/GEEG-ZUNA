...
> **Superseded 2026-08-21:** this document specified the invalid dependency-free
> approximation and is retained only as design history. The operative Phase 3
> contract is `PHASE3_METRIC_CORRECTNESS.md`; active runs use pinned official
> `specparam==2.0.0rc7`. Do not use the helper or smoke values below for new results.
